...
- Full-stack web dev (PHP, Python, Django)
- Data structures & algorithms
- Backend/API development

## Projects

**[JFD Tech Solutions](https://jfdtech.info)** — Business portfolio site with services showcase and contact system. Built with PHP.

**[UOS GPA & CGPA Calculator](https://play.google.com/store/apps/details?id=com.jfdtech.uos_gpa_calculator)** — Flutter app for University of Sargodha students to track semester GPA & CGPA.

**[Stock Portfolio Management System](https://github.com/Daniyal674/Stock-Portfolio-Manager)** — C++ console app for tracking stock inventory, purchases, and sales.

**[Timetable & Room Management System](https://ituos.infinityfree.me)** — Web system for scheduling classes and managing room bookings.

## Tech Stack
<p align="left">
  <img src="https://skillicons.dev/icons?i=cpp,c,js,php,python,dart,flutter,django,bootstrap,mysql,sqlite,git,github" />
</p>
